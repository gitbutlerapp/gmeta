...
PAGE_ORDER = [
    ...
    "implementation-specific/storage.md",
    "implementation-specific/cli.md",
    "implementation-specific/output.md",
    "implementation-specific/workflow.md",
]
...
:root[data-theme='dark'] {
  ...
  --button-active: rgba(255,255,255,0.08);
}
...
@media (prefers-color-scheme: light) {
  :root[data-theme='system'] {
    ...
    --button-hover: rgba(15,23,42,0.08);
    --button-active: rgba(29,78,216,0.12);
  }
}
